                  ...
                  <table id="example" class="table table-striped responsive-utilities jambo_table">
                    <thead>
                      <tr class="headings">
                        ...
                        <th>充值金额</th>
                        <th>充值日期</th>
                        <th class=" no-link last"><span class="nobr">银行卡号</span>
                        </th>
                      </tr>
                    </thead>

                    <tbody>
                 <s:iterator id="item" value="rechargeList">
                      <tr class="even pointer">
                        <td class=" "><s:property value="#item.rechargeId"/></td>
                        <td class=" "><s:property value="#item.cardNum"/> </td>
                        <td class=" "><s:property value="#item.payment"/></td>
                        <td class=" "><s:property value="#item.date"/></td>
                        <td class="last"><s:property value="#item.bankAccount"/></td>
                      </tr>
   					</s:iterator>                  
                 </tbody>
