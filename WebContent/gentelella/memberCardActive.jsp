      ...
      <div class="col-md-3 left_col">
        <div class="left_col scroll-view">
          ...
          <div class="navbar nav_title" style="border: 0;">
            <a href="#" class="site_title"><i class="fa fa-paw"></i> <span>会员系统</span></a>
          </div>
              ...
              <ul class="nav side-menu">
                ...
                <li><a><i class="fa fa-edit"></i> 会员信息 <span class="fa fa-chevron-down"></span></a>
                  <ul class="nav child_menu" style="display: none">
                    ...
                    <li><a href="memberConsumeRecord">消费记录</a>
                    </li>
                    <li><a href="showMemberRecharge">充值记录</a>
                    </li>
                  </ul>
                </li>
              </ul>
        ...
        <div class="nav_menu">
          <nav class="" role="navigation">
            ...
            <ul class="nav navbar-nav navbar-right">
              <li class="">
                <a href="memberLogin.jsp" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                  <img src="images/img.jpg" alt=""> 注销登录
...
<!--                    <div class="form-group">
                     ...
                     <div class="form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="text"  name="last-name" disabled="disabled" value="200" id="payment" class="form-control col-md-7 col-xs-12">
                      </div>
                    </div> 
                     <div class="ln_solid"></div>                                           
                    <div class="form-group">
                      <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                        <button class="btn btn-success" id="pay">确认激活</button>
                      </div>
                    </div>                     
