                ...
                <div class="x_content">
                  ...
                  <form id="demo-form2" data-parsley-validate="" class="form-horizontal form-label-left">
                    ...
                    <div class="form-group">
                      <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">当前余额<span class="required">*</span>
                      </label>
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="text" disabled="disabled"  value="${balance}"  class="form-control col-md-7 col-xs-12">
                      </div>
                    </div> 
<!--                    <div class="form-group">
                     ...
                     <div class="form-group">
                      <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name">当前积分<span class="required">*</span>
                      </label>
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="text"  name="last-name" disabled="disabled" value="${points}" id="max" class="form-control col-md-7 col-xs-12">
                      </div>
                    </div> 
                                      
                     <div class="form-group">
                      <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name">兑换积分<span class="required">*</span>
                      </label>
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="text"  name="last-name" value="0" id="points" class="form-control col-md-7 col-xs-12">
                      </div>
                    </div> 
                    ...
                    <div class="form-group">
                      <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                        <button class="btn btn-success" id="change">确认兑换</button>
                      </div>
                    </div>                     
                  </form>
                </div>
  ...
  $('#change').click(function() {
	  var changePoints = $('#points').val();  
	  var points=$('#max').val();
	  alert(changePoints+"www"+points);
	  if(changePoints<=points){
 		$.ajax({
			type : "post", //请求方式
			url : "memberPoints", //发送请求地址
			data : {
