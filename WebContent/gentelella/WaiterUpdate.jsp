...
<div class="x_panel">
                  ...
                  <form id="demo-form2" data-parsley-validate="" class="form-horizontal form-label-left">
                    ...
                    <div class="form-group" >
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="text" class="form-control" disabled="disabled" placeholder=${waiterName}>
                      </div>
                    </div>
                    <div class="form-group">
                      <label for="middle-name" class="control-label col-md-3 col-sm-3 col-xs-12">新密码<span class="required">*</span>
                      </label>
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="text" id="password"  password=${waiterPassword} class="form-control">
                      </div>
                    </div>                    
                    <div class="form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="text" id="phoneNum" class="form-control" placeholder=${waiterPhoneNum}>
                      </div>
                    </div>
                     <div class="form-group" >
                      <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">所属店面<span class="required">*</span>
                      </label>
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="text" class="form-control" disabled="disabled" placeholder=${storeID}>
                      </div>
                    </div>                   
  ...
  $('.btn.btn-success').click(function() {
	  var waiterPhoneNum=$('#phoneNum').val();
	  var password = $('#password').val();
	  if(waiterPhoneNum==""){
		  waiterPhoneNum=$('#phoneNum').attr('placeholder');;
		  
	  }
	  if(password==""){
		  password=$('#password').attr('password');
		  
	  }	  
	  alert(waiterPhoneNum+"+"+password);
	  
 		$.ajax({
			type : "post", //请求方式
			url : "updateWaiterInfo", //发送请求地址
			data : {
